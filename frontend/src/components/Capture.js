  ...
  return (
    <div className="my-20 text-white">
      <div className="flex">
        ...
        <div
          className={`w-1/2 ${isRecording ? "hidden" : "flex m-auto"}`}
          id="video-upload"
        >
          <div
          ...
          >
            <div className="flex flex-col">
              ...
              <h3 className="text-lg ">Upload Video</h3>
              <input
                type="file"
